...
Исходные данные
Входные данные содержат сообщение Анжелы, которое состоит из латинских букв в верхнем регистре, пробелов, переводов строк
и знаков препинания: точек, запятых, тире, двоеточий, восклицательных и вопросительных знаков. Общая длина сообщения не превосходит 10000 символов.
Результат
